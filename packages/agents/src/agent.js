 ...
 */
import { DefaultToolRegistry, executeTool, } from './tools.js';
    ...
    async execute(context, input) {
        ...
        try {
            ...
            for (let step = 0; step < context.maxSteps; step++) {
                ...
                try {
                    const { output, durationMs } = await executeTool(reasoningResult.toolName, reasoningResult.toolInput || {}, this.toolRegistry, context.timeout / 2);
